                            ...
                            <div class="col-lg-9 col-md-8">
                                <div class="header-top-right">
                                    <ul class="ht-menu">
                                        <!-- Begin Setting Area -->
                                        <li>
                                            <div class="ht-setting-trigger"><span> Quản lý tài khoản</span></div>
                                ...
                                if(isset($fullname)){
                                    echo    '<li>
                                                <div class="ht-setting-trigger"><span>'.$fullname.'</span></div>
                                            </li>';
                                }
                                ?>
                                        <li>
                                ...
                                <div class="hb-menu">
                                    <nav>
                                        <ul>
                                            ...
                                            <li><a href="http://localhost/Laptrinhweb/Home/lienhe">Liện hệ</a></li>
